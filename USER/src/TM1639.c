...
{
    if(uvtime.hundreds > 9) TM1639_DisplayChar(DISPLAY_ADDR0,' ',0);
    else
    {
    ...
    if(uvtime.decde > 9) TM1639_DisplayChar(DISPLAY_ADDR1,' ',0);
    else
    {
    ...
    if(uvtime.unit > 9) TM1639_DisplayChar(DISPLAY_ADDR2,' ',0);
    else
    {
